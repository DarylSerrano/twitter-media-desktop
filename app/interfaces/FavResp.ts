...
export interface FavResp {
  ...
  text: string;
  truncated: boolean;
  entities: FavRespEntities;
  extended_entities: FavRespExtendedEntities;
  source: string;
...
export interface FavRespEntities {
  hashtags: unknown[];
  symbols: unknown[];
...
export interface FavRespExtendedEntities {
  media: PurpleMedia[];
}
